export default function Footer() {
  return (
    <footer className="bg-black text-white py-10 mt-20 border-t border-gray-800">
      <div className="max-w-4xl mx-auto text-center">
        
       
        <h2 className="text-xl font-semibold mb-3">
          © {new Date().getFullYear()} Hakan Öztürk
        </h2>
        ...
        <div className="flex justify-center gap-6 mb-6">
          ...
          <a 
            href="https://www.linkedin.com/in/hakan-%C3%B6zt%C3%BCrk-92242a37b/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3B9yIZzdwwRwKbjcdF7gyFQg%3D%3D"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-gray-300 transition"
          >
